...
namespace SayOnlinePanel.Data.Migrations
{
    ...
    [Migration("20201209100750_CreateTargetAnswerCorect")]
    partial class CreateTargetAnswerCorect
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SayOnlinePanel.Data.Models.TargetAnswer", b =>
                {
                    ...
                    b.Property<int?>("TargetQuestionId1")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SayOnlinePanel.Data.Models.TargetAnswer", b =>
                {
                    b.HasOne("SayOnlinePanel.Data.Models.TargetQuestion", null)
                        .WithMany("TargetAnswers")
                        .HasForeignKey("TargetQuestionId");

                    b.HasOne("SayOnlinePanel.Data.Models.TargetQuestion", null)
                        .WithMany("TargetAnswersHaveChecked")
                        .HasForeignKey("TargetQuestionId1");
                });
